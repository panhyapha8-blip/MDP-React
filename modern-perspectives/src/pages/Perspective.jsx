// src/pages/Perspective.jsx
import { useState, useEffect } from "react";
import { useParams, useNavigate } from "react-router-dom";
import Border from "../components/Border";          // adjust path if needed
...
export default function Perspective() {
  ...
  return (
    ...
    <div className="perspective-page">
      <button className="perspective-back-btn" onClick={() => navigate("/messages")}>
        ← Back
      </button>
          ...
          >
            <div className={`card-inner${flipped ? " flipped" : ""}`}>
              ...
              <div className="card-front">
                <img src={imageUrl} alt={post.author_name} title={post.description} />
                <article>
